...
const SWATCH_DIR = path.join(process.cwd(), "public", "swatches");
...
export default async function handler(
  ...
  try {
    ...
    console.log("[bedrock-pattern] raw response:", text);
    ...
    console.log("[bedrock-pattern] parsed:", parsed);
    ...
    if (
      ...
      console.error("[bedrock-pattern] invalid coordinates/size:", parsed);
    ...
    await setCachedPalette(filename, "Nova Lite Pattern", parsed);
    ...
    console.error("Bedrock pattern error:", err);
